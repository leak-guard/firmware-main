...
public:
    ...
    ~EspSocketImpl() = default;
    EspSocketImpl(const EspSocketImpl&) = delete;
    EspSocketImpl(EspSocketImpl&&) = delete;
    EspSocketImpl& operator=(const EspSocketImpl&) = delete;
    EspSocketImpl& operator=(EspSocketImpl&&) = delete;
